...
namespace Downtown.Data
{
    public class DowntownDbContext : DbContext, IUnitOfWork
    {
        public DowntownDbContext(DbContextOptions options) : base(options)
        {
        }
        ...
        {
            MethodInfo[] mapMethods = typeof(DowntownDbContext)
                .Assembly
                .GetTypes()
